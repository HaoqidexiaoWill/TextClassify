...
class BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.classifier = nn.Linear(len(filter_sizes) * n_filters*2, config.num_labels)
    ...
    def forward(self,
        ...
        logits  = self.classifier(torch.cat([utterance_cat,response_cat],dim = -1))
