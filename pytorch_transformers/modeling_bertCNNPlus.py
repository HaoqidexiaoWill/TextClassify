...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,
        ...
        encoded_layers, hidden_state = self.bert(input_ids=flat_input_ids, position_ids=flat_position_ids, token_type_ids=flat_token_type_ids,
        ...
        pooled = [nn.functional.max_pool1d(conv, conv.shape[2]).squeeze(2)
                  for conv in conved]
