...
from Model.TextCNNIncDeep import TextCNNIncDeep
...
class BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.convs_hist = TextCNNIncDeep(config.hidden_size,768,128,12)
        self.convs_utt = TextCNNIncDeep(config.hidden_size,768,48,12)
        # 最后的全连接层
        self.fc = nn.Sequential(
            nn.Linear(1024*3,config.hidden_size),
    ...
    def forward(self,
        ...
        history_conved = self.convs_hist(context_hist)
