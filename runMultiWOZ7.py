...
from pytorch_transformers.modeling_bertSeqTaging4 import BertForTokenClassification
...
from DATAProcess.LoadDATAMultiWOZ3 import DATAMultiWOZ
...
class Trainer:
    ...
    def create_dataloader(self):
        ...
        all_labels_domainslot = torch.tensor([f.labels_domainslot for f in train_features], dtype=torch.float)
        ...
        train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids,all_labels_domainslot, all_labels_domain,all_labels_dependcy)
        ...
        eval_labels_domainslot = torch.tensor([f.labels_domainslot for f in eval_features], dtype=torch.float)
        ...
        eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids,eval_labels_domainslot, eval_labels_domain,eval_labels_dependcy)
...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        data_dir = '/home/lsy2018/TextClassification/DATA/DATA_MultiWOZ/data_1133/',
        output_dir = './model_MultiWOZ_1133',
        # DOUBAN 是二分类
