...
class BIMPM(nn.Module):
    ...
    def __init__(self, args, data):
        ...
        self.word_emb = nn.Embedding(num_embeddings=args.word_vocab_size, embedding_dim=args.word_dim)
    ...
    def forward(self, **kwargs):
        ...
        p1_input = self.word_emb(kwargs['p'])  # 256*1*300
        p2_input = self.word_emb(kwargs['h'])
        #        iii = 0
        #        if iii<10:
        #        print(p1_input.shape,'/*\\',p2_input.shape)
        #        print()
        if self.args.use_char_emb:
