...
class InputExample(object):
    ...
    def __init__(self, sentence_ID1,sentence_ID2,text_a, text_b=None, label=None):
        ...
        """
        self.sentence_ID1 = sentence_ID1
        self.sentence_ID2 = sentence_ID2
        self.text_a = text_a
        self.text_b = text_b
        self.label = label
...
def read_examples(input_file, is_training):
    ...
    for val in df[['dialogid', 'userutt', 'answerid', 'resp', 'label']].values:
        examples.append(InputExample(sentence_ID1=val[0],sentence_ID2=val[2], text_a=val[1], text_b=val[3], label=val[4]))
    return examples
    ...
    for example_index, example in enumerate(examples):
        ...
        for i in range(split_num):
            ...
            if example_index < 1 and is_training:
                ...
                logger.info("sentence_ID1: {}".format(example.sentence_ID1))
                logger.info("sentence_ID2: {}".format(example.sentence_ID2))
        ...
        features.append(
            InputFeatures(
                sentence_ID1=example.sentence_ID1,
                sentence_ID2=example.sentence_ID2,
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='/home/lsy2018/文本匹配/datapro/ubuntu/', type=str, required=False,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default='bert', type=str, required=False,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default='/home/lsy2018/文本匹配/uncased_L-12_H-768_A-12', type=str, required=False,
    ...
    if args.do_train:
        ...
        train_examples = read_examples(os.path.join(args.data_dir, 'train.txt'), is_training=True)
