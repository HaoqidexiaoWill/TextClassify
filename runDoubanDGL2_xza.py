from DATAProcess.LoadDataDoubanDGL_xza import DataDOUBAN
...
from Model.GCN_xza2 import Classifier
...
class Trainer:
    ...
    def train(self):
        ...
        embedding_matrix = trainset.build_embedding_matrix()
        model = Classifier(embedding_matrix.size()[1], 256, trainset.num_classes, embedding_matrix, self.device).to(self.device)
...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        ...
        output_dir = './model_DOUBAN_DGL_xza')
    trainer.train()
